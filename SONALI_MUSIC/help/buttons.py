...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("- s ʜ ᴏ ɴ ᴀ › ǫᴛ 𝃵⎯̽⇢🎫", url="https://t.me/Theshonaqueen")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/shona_bots"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/+cpc-CeRmKTBiMWI1"),
        ],
        [
